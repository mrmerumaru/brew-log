...
const SETUP_COLUMNS =
  "id,created_at,drink,method,machine_brand,machine_model,grinder,bean_name,bean_type,origin,process,roast_level,roast_date,milk_brand,milk_type,grind_size,grind_unit,dose_g,water_g,water_temp_c,brew_time_s";
